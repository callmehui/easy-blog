      ...
      <div id="resume" class="grid grid-cols-12 mt-4 mb-8">
        ...
        <div class="px-8 py-6 pb-4 lg:col-span-7 md:col-span-12">
          ...
          <ul>
            <li class="my-1 text-base text-gray-600">
              姓名：
              <span class="text-gray-500 text">钟辉</span>
            </li>
            <li class="my-1 text-base text-gray-600">
              年龄：
              <span class="text-gray-500 text">26</span>
            </li>
            <li class="my-1 text-base text-gray-600">
              工作年限：
              <span class="text-gray-500 text">1年前后端 + 3年全职前端</span>
            </li>
          </ul>
          <!-- 教育经历 -->
          <h2
          ...
          <h3 class="mt-5 mb-2 text-lg font-medium text-red-500">
            <a href="http://www.hubu.edu.cn/" target="__blank">湖北大学</a>
          </h3>
          <ul>
            <li class="text-base text-gray-600">
              学士，软件工程
              <span class="text-sm text-gray-500">[2013 - 2017]</span>
            </li>
          </ul>
          <!-- 专业技能 -->
          <h2
          ...
          <ol>
            <li class="my-1 text-base text-gray-600">
              <b>Vue2全家桶</b>：
              <span class="text-gray-500 text">熟练掌握，工作中多次使用；</span>
            </li>
            <li class="my-1 text-base text-gray-600">
              <b>Vue3全家桶：</b>：
            ...
            <li class="my-1 text-base text-gray-600">
              ...
              <span class="text-gray-500 text"
                >熟练掌握，在公司项目和个人项目多次使用；</span
              >
            </li>
            <li class="my-1 text-base text-gray-600">
              小程序：
              <span class="text-gray-500 text"
                >熟练使用<b>Uniapp</b>和<b>Taro</b>，在公司项目和个人项目开发了多个小程序；</span
              >
            </li>
            <li class="my-1 text-base text-gray-600">
              构建工具：
              <span class="text-gray-500 text"
                >熟练使用<b>Vite</b>和<b>Webpack</b>，了解前端性能优化手段；</span
              >
            </li>
            <li class="my-1 text-base text-gray-600">
              后端技术：
              <span class="text-gray-500 text"
                >熟悉<b>Node.js</b>、<b>PHP</b>、<b>Java</b>，熟悉<b>Nginx</b>、pm2等；</span
              >
            </li>
          </ol>
          <!-- 项目（工作） -->
          ...
          <ul>
            ...
            <li class="my-1 text-[15px] text-gray-600">
              ...
              >的列表派单功能，不仅大大提升了此处代码的<i><b>可读性</b></i
              >、<i><b>可维护性</b></i
              >，同时提升了列表派单页面的<b>10%</b>性能，稳步上线之后<i>没有出现任何线上问题</i>；
            </li>
          </ul>
          <h3>
          ...
          <h3 class="mt-5 mb-2 text-lg font-medium text-red-500">
            <a href="https://music-player.immortalboy.cn/" target="__blank"
              >仿网易云音乐播放器</a
            >
            <span class="ml-2 text-sm font-normal text-gray-400"
              >[2018.08 - 2020-01]</span
            >
          </h3>
          <ul>
            <li class="text-base text-gray-600">
              基于<b>Vue3</b>、<b>Typescript</b>和<b>Vite</b>开发的仿网易云音乐客户端web版本。
            </li>
            <li class="text-base text-gray-600">
          ...
          <h3 class="mt-5 mb-2 text-lg font-medium text-red-500">
            <a href="https://immortalboy.cn/" target="__blank">个人博客</a>
            <span class="ml-2 text-sm font-normal text-gray-400">-</span>
            <span class="ml-2 text-sm font-normal text-gray-400"
              >[2021-10 - 至今]</span
            >
          ...
          <ul>
            <li class="text-base text-gray-600">
              使用<b>Vue3</b>、<b>egg.js</b>搭建，分享个人技术和生活的博客文章。
            </li>
          </ul>
        </div>
        <!-- 简历右侧 -->
        <div class="col-span-5 py-6 ml-5 mr-8">
          ...
          <ul>
            <li class="my-1 text-base text-gray-600">
              电话：
              <span class="text-gray-500 text">13720141463</span>
            </li>
            <li class="my-1 text-base text-gray-600">
              微信：
              <span class="text-gray-500 text">a13720141463</span>
            </li>
            <li class="my-1 text-base text-gray-600">
              邮箱：
